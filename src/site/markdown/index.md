...
See the generated **Plugin Documentation** report for goal and parameter details.

For architecture, capability boundaries, and roadmap, use the repository documentation:
